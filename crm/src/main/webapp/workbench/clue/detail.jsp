		...
		$("#searchByactivity").keydown(function (event) {
			if (event.keyCode==13){
				...
				$.ajax({
					...
					data:{
						"clueId":"${clue.id}",
						"aname":$.trim($("#searchByactivity").val())
					},
					type:"get",
					dataType:"json",
					success:function (data) {
						...
						$("#searchByactivityTboty").html(html);
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="searchByactivity" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
					...
					<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						...
						<tbody id="searchByactivityTboty">
						<%--	<tr>
								<td><input type="checkbox"/></td>
								<td>发传单</td>
								<td>2020-10-10</td>
				...
				<div class="modal-footer">
					...
					<button type="button" id="bund" class="btn btn-primary" data-dismiss="modal">关联</button>
				</div>
			</div>
		</div>
	</div>
